    ...
    <header>
      <nav>
        ...
        <div class="nav__btns">
          <?php if(isset($_SESSION['user_id'])): ?>
            <!-- User is logged in -->
            <span style="color:white; margin-right:10px;">Welcome, <?php echo $_SESSION['user_email']; ?>!</span>
            <a href="logout.php"><button class="btn btn__secondary">Logout</button></a>
          <?php else: ?>
            <!-- User not logged in -->
            <a href="signup.html"><button class="btn btn__primary">Sign Up</button></a>
            <a href="signin.html"><button class="btn btn__secondary">Sign In</button></a>
          <?php endif; ?>
        </div>
      </nav>
      <div class="section__container header__container" id="home">
        ...
        <div class="header__content">
          ...
          <p>
            Discover RentalX car rental options in India with Rent a Car Select
...
<section class="section__container steps__container" id="rent">
  ...
  <div class="steps__grid">
    ...
    <!-- Choose a location (Map) -->
    <a href="map.php" class="steps__card-link">
    ...
    <!-- Step 2: Pick-up date -->
    <div class="steps__card" id="pickup-date-card">
      ...
      <input type="date" id="pickup-date-input" style="display:none; margin-top:10px;">
    </div>

    <a href="book_car.php" class="steps__card-link">
      <div class="steps__card">
        <span><i class="ri-bookmark-3-fill"></i></span>
        <h4>Book your car</h4>
        <p>Browse and book a car instantly.</p>
      </div>
    </a>
    ...
    <footer>
      ...
      <div class="section__container footer__bar">
        <h4>RentalX</h4>
        <p>Copyright © Sushant. All rights reserved.</p>
...
<script>
  // Show date picker when user clicks the Step 2 card
  const dateCard = document.getElementById('pickup-date-card');
